...
SUBROUTINE OOOPtema_Start (Object, chrTeamMembersFileName)
  ...
  !
write(*,*) '(1) TeamManager started on Image: ', THIS_IMAGE()
  !
  ...
  DO intCounter = 1, Object % m_intNumberOfTeamMembers
    ! (mA_intTeamMemberImages99(intCounter) gives the remote image number):
    intRemoteImageNumber = Object % mA_intTeamMemberImages99(intCounter)
    CALL IItema_ActivateTeamMemberImage (Object, intRemoteImageNumber)
  END DO
  !
                                                                CALL OOOGglob_subResetProcedures
...
!  chrPathAndFileName = TRIM(chrStartPath) // 'TeamMembers_1.txt' !160725: hard coded to suppress a run-time
                                                                 ! error within the test program
  !
...
!___________________________________________________________
!
SUBROUTINE IItema_ActivateTeamMemberImage (Object, intRemoteImageNumber)
