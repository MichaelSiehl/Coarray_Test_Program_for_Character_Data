...
SUBROUTINE OOOPimma_Start (Object)
  ...
  IF (THIS_IMAGE() == 1) THEN
    ! on image 1 only: check if the number of images is not less 3,
    ...
    IF (NUM_IMAGES() .LT. 3) THEN
      ...
      WRITE(*,*) ' ** than 2 for the program to execute !'
...
write(*,*) '(3) character after remote transfer: ', chrTeamMembersFileName
